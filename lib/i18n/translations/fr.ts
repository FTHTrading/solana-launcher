...
const fr: TranslationDictionary = {
  ...
  section_devnetLaunch_subtitle: 'Chaque jeton créé via la plateforme génère ces artefacts vérifiables. Essayez l\'assistant sur devnet pour créer le vôtre — cela prend 30 secondes.',
  ...
  devnetLaunch_viewMint: 'Explorer Devnet',
  ...
  devnetLaunch_mintDesc: 'Chaque jeton reçoit une adresse SPL unique — vérifiable sur Solscan après lancement',
  devnetLaunch_txDesc: 'Enregistrement de transaction signé avec trace complète des instructions',
  devnetLaunch_metadataDesc: 'Nom, symbole et URI de l\'image servis depuis le CDN de la plateforme',
  devnetLaunch_imageDesc: 'Visuel du jeton hébergé sur le CDN — prêt pour le pinning IPFS',
  devnetLaunch_explorerDesc: 'Page détaillée du jeton avec supply, autorités et métadonnées',
  devnetLaunch_tryCta: 'Essayer l\'assistant sur Devnet',
  devnetLaunch_note: 'Chaque lien ci-dessus est en direct et vérifiable. Lancez votre propre jeton sur devnet pour voir le reçu complet sur Solscan. Les jetons Devnet n\'ont aucune valeur monétaire.',

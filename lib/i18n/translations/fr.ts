...
const fr: TranslationDictionary = {
  ...
  section_scorecard_subtitle: 'Une correspondance directe entre vos exigences et ce qui existe déjà dans ce système.',
  ...
  homepage_scorecardItems: [
    ...
    { asked: 'Chemin de liquidité', status: 'Préparé', forYou: 'Implémentation Phase 2' },
  ],

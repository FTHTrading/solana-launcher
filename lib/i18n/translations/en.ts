...
const en: TranslationDictionary = {
  ...
  section_scorecard_subtitle: 'A direct mapping between your project requirements and what already exists in this system.',
  ...
  homepage_scorecardItems: [
    ...
    { asked: 'Liquidity path', status: 'Prepared', forYou: 'Phase 2 implementation' },
  ],
